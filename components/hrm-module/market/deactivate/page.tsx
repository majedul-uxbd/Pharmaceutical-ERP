...
interface DeactivateMarketProps {
    id: number;
    accessToken: string;
    onInactiveSuccess: () => void;
}

const DeactivateMarket = ({ id, accessToken, onInactiveSuccess }: DeactivateMarketProps) => {
    ...
    const handleDelete = async () => {
        ...
        const response = await fetch(
            `${process.env.NEXT_PUBLIC_API_URL}/market/inactive`,
            {
                method: 'POST',
                headers: {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
                ...
                <DialogDescription>
                    Are you sure you want to inactive this Market?
                </DialogDescription>
                <DialogFooter>
...
export default DeactivateMarket;
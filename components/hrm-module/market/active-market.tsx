...
interface ActivateRegionProps {
    id: number;
    accessToken: string;
    onActiveSuccess: () => void;
}

const ActivateMarket = ({ id, accessToken, onActiveSuccess }: ActivateRegionProps) => {
    ...
    const handleDelete = async () => {
        ...
        const response = await fetch(
            `${process.env.NEXT_PUBLIC_API_URL}/market/active`,
            {
                method: 'POST',
                headers: {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
                ...
                <DialogDescription>
                    Are you sure you want to active this Market?
                </DialogDescription>
                <DialogFooter>

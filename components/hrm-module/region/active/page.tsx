...
const ActivateRegion = ({ id, accessToken, onActiveSuccess }: ActivateRegionProps) => {
    ...
    const handleDelete = async () => {
        ...
        const response = await fetch(
            `${process.env.NEXT_PUBLIC_API_URL}/region/active`,
            {
                method: 'POST',
                headers: {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
                ...
                <DialogDescription>
                    Are you sure you want to active this Region?
                </DialogDescription>
                <DialogFooter>

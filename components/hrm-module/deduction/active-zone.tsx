...
interface DeactivateZoneProps {
    id: number;
    accessToken: string;
    onActiveSuccess: () => void;
}

const ActivateZone = ({ id, accessToken, onActiveSuccess }: DeactivateZoneProps) => {
    ...
    const handleDelete = async () => {
        ...
        const response = await fetch(
            `${process.env.NEXT_PUBLIC_API_URL}/zone/active`,
            {
                method: 'POST',
                headers: {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={setIsOpen}>
            ...
            <DialogContent>
                ...
                <DialogDescription>
                    Are you sure you want to active this zone?
                </DialogDescription>
                <DialogFooter>
